  ...
  return (
    <div className='flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6'>
      ...
      <div className='sm:flex hidden flex-row justify-end gap-4'>
        <CustomButtons btntype="button" title={address ? 'Create a Campaign' : 'Connect'} styles={address ? 'bg-[#1dc071]' : 'bg-[#8c6dfd]'} handleclick={() => { if (address) { navigate('create-campaign') } else {connectWallet()} }} />
        <Link to="/profile">
